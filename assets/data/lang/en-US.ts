export default {
  ...
  PREVISIONS_2050: 'Here is what the forecasts for 2050 look like if the situation does not change.',
  OTHER_FUTURE: 'However, there is a second possible future.',
  GO_2050: '2050 is coming fast but there is still time to act!',
  DESASTER_2050: 'Everest is just one example of the disasters caused by mass tourism.',
  CHANGE_THINGS_2050: 'By supporting these organizations, we have the opportunity to change things.',
  CREDITS: 'Credits',
