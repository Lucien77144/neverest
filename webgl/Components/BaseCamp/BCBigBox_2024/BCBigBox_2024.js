...
export default class BCBigBox_2024 extends BasicItem {
  ...
  setInstances() {
    ...
    // }).instance
    const instance = this.resources.BCBigBox_2024.scene.children[0]
    const dummy = new Object3D()
    this.item = new InstancedMesh(instance.geometry, instance.material, BCBIGBOX_2024.length)
   ...
   */
  setItem() {
    this.item = this.resources.BCBigBox_2024.scene.clone()
